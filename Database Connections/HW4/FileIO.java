...
public class FileIO {
	...
	public static void writeToHTML(String query, ResultSet rs) throws IOException, SQLException{
		...
		int endNumber = queryPrompt.indexOf(".");
		String queryNumber = query.substring(index+3,endNumber);

		// Location and name of the output HTML file that we want to write to
		String htmlFile = "C:/Users/Ambrosio/Desktop/Assignment4"+queryNumber+".html";
