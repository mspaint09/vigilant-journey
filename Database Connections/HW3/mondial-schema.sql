...
create table mondial.test(t text)

insert into mondial.test values ('text1');

Drop table mondial.mondial;

Drop table mondial.test;

show search_path;

ALTER DATABASE postgres SET search_path="$user",mondial,public,CS031A;
...
CREATE TABLE mondial.Countrypops
(Country VARCHAR(4),
...
CREATE TABLE mondial.Countryothername
(Country VARCHAR(4),
 othername VARCHAR(50),
 CONSTRAINT CountryOthernameKey PRIMARY KEY (Country, othername));

CREATE TABLE mondial.Provpops
(Province VARCHAR(50),
 Country VARCHAR(4),
...
CREATE TABLE mondial.Provinceothername
(Province VARCHAR(50),
 Country VARCHAR(4),
 othername VARCHAR(50),
 CONSTRAINT ProvOthernameKey PRIMARY KEY (Country, Province, othername));

CREATE TABLE mondial.Citypops
(City VARCHAR(50),
 Country VARCHAR(4),
 Province VARCHAR(50),
...
CREATE TABLE mondial.Cityothername
(City VARCHAR(50),
 Country VARCHAR(4),
 Province VARCHAR(50),
 othername VARCHAR(50),
...
CREATE TYPE mondial.GeoCoord AS
(Latitude DECIMAL,
 Longitude DECIMAL);
...
CREATE TABLE mondial.locatedOn
(City VARCHAR(50) ,
 Province VARCHAR(50) ,
 Country VARCHAR(4) ,
 Island VARCHAR(50) ,
...
CREATE TABLE mondial.islandIn
(Island VARCHAR(50) ,
 Sea VARCHAR(50) ,
 Lake VARCHAR(50) ,
 River VARCHAR(50) );

CREATE TABLE mondial.MountainOnIsland
(Mountain VARCHAR(50),
 Island   VARCHAR(50),
 CONSTRAINT MountainIslKey PRIMARY KEY (Mountain, Island) );

CREATE TABLE mondial.LakeOnIsland
(Lake    VARCHAR(50),
 Island  VARCHAR(50),
 CONSTRAINT LakeIslKey PRIMARY KEY (Lake, Island) );

CREATE TABLE mondial.RiverOnIsland
(River   VARCHAR(50),
 Island  VARCHAR(50),
 CONSTRAINT RiverIslKey PRIMARY KEY (River, Island) );

CREATE TABLE mondial.Airport
